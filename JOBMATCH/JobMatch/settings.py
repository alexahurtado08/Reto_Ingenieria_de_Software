...
SECRET_KEY = 'django-insecure-ca3k+3ricj2k(h=r9-#qix&*fml@p1ftfz&e+cni-i+3u%+%d^'
...
LOGIN_URL = 'login'  # o el nombre correcto de tu url de login
LOGIN_REDIRECT_URL = 'dashboard'
LOGOUT_REDIRECT_URL = 'login'

STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "dashboard/static",  # Ruta a tus archivos estáticos
]
